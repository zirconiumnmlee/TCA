...
def load_2wiki_data(input_dir: str) -> List[Dict[str, Any]]:
    ...
    file_path = os.path.join(input_dir, "2wiki_dev_200.json")
...
def main(args):
    config = Config(dataset="2wiki")
    input_dir = config.input_corpus_dir

    print(f"📂 Loading 2wiki data from: {input_dir}")
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Build Elasticsearch sparse index for 2wiki")
