...
def load_hotpotqa_data(input_dir: str) -> List[Dict[str, Any]]:
    ...
    file_path = os.path.join(input_dir, "hotpot_dev_200.json")
...
def main(args):
    config = Config(dataset="hotpotqa")
    input_dir = config.input_corpus_dir

    print(f"📂 Loading HotpotQA data from: {input_dir}")
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Build Elasticsearch sparse index for HotpotQA")
